...
|Address|Name                     |R/W|Description                                                                                                  |
|-------|-------------------------|---|-------------------------------------------------------------------------------------------------------------|
|0x2C00 |主机故障字               |   |bit0:主机系统故障                                                                                            |
|0x2C01 |Reserve                  |   |                                                                                                             |
|0x2C02 |系统开关机               |   |写入1有效;Bit0:开机0x0001;Bit1:关机0x0002                                                                    |
|0x2C03 |系统运行模式             |   |新风模式:0x0000;制冷模式:0x0001;制热模式:0x0002;除湿模式:0x0002;                                                                                                             |
|0x2C04 |通风制冷/除湿模式设定相对湿度  |   |INT16U,0x0020 表示：当前运行设定湿度为32%      范围45%到65%  精度1                                                                                                             |
|0x2C05 |通风设定风速             |   |低风:0x0001;中风:0x0002;高风:0x0003;                                                                                                             |
|0x2C06 |通风制冷设定温度(控制回风温度) |   |INT16U,0x00FF 分辨率0.5   (步长)0.5度 当前制冷设定温度是26.0度，范围16到35度                                                                                                             |
|0x2C07 |通风制热设定温度(控制回风温度) |   |INT16U,0x00FF 分辨率0.5   (步长)0.5度 当前制热设定温度是20.0度，范围16到35度                                                                                                             |
|0x2C08 |新风低风量PWM值          |   |INT16U,0x0020 表示：PWM输出值为32%    范围0%到100%                                                                                                              |
|0x2C09 |新风中风量PWM值          |   |INT16U,0x0020 表示：PWM输出值为32%    范围0%到100%                                                                                                              |
|0x2C0A |新风高风量PWM值          |   |INT16U,0x0020 表示：PWM输出值为32%    范围0%到100%                                                                                                              |
|0x2C0B |回风低风量PWM值          |   |INT16U,0x0020 表示：PWM输出值为32%    范围0%到100%                                                                                                              |
|0x2C0C |回风中风量PWM值          |   |INT16U,0x0020 表示：PWM输出值为32%    范围0%到100%                                                                                                              |
|0x2C0D |回风高风量PWM值          |   |INT16U,0x0020 表示：PWM输出值为32%    范围0%到100%                                                                                                              |
|0x2C0E |主机制冷模式设定水温     |   |INT16U,0x0014 分辨率0.5   (步长)0.5度 当前温度是20.0度   范围5度到80度                                                                                                             |
|0x2C0F |主机制热模式设定水温     |   |INT16U,0x0019 分辨率0.5   (步长)0.5度 当前温度是25.0度   范围5度到80度                                                                                                             |
|0x2C10 |主机生活热水设定水温     |   |INT16U,0x00FF 分辨率0.5   (步长)0.5度 当前温度是25.0度   范围5度到80度                                                                                            |
|0x2C11 |户外进风口温度T0R        |   |INT16S,0x00FA 表示：当前进风口温度是25.0度                                                                                                             |
|0x2C12 |户外进风口湿度T0R        |   |INT16U,0x0020 表示：当前进风口湿度是32%                                                                    |
|0x2C13 |氟盘前温度T1R            |   |INT16S,0x00FA 表示：当前进风口温度是25.0度                                                                                                             |
|0x2C14 |氟盘前湿度T1R            |   |INT16U,0x0020 表示：当前进风口湿度是32%                                                                                                             |
|0x2C15 |氟盘后温度T2R            |   |INT16S,0x00FA 表示：当前进风口温度是25.0度                                                                                                             |
|0x2C16 |氟盘后湿度T2R            |   |INT16U,0x0020 表示：当前进风口湿度是32%                                                                                                             |
|0x2C17 |回风口温度               |   |INT16S,0x00FA 表示：当前进风口温度是25.0度                                                                                                             |
|0x2C18 |回风口湿度               |   |INT16U,0x0020 表示：当前进风口湿度是32%                                                                                                             |
|0x2C19 |排风口温度               |   |INT16S,0x00FA 表示：当前进风口温度是25.0度                                                                                                             |
|0x2C1A |排风口湿度               |   |INT16U,0x0020 表示：当前进风口湿度是32%                                                                                                             |
|0x2C1B |环控回风口CO2浓度        |   |INT16U,0x000A 表示：测量CO2值是 10PPM   范围450到2000PPM                                                                                                             |
|0x2C1C |环控回风口PM2.5浓度      |   |INT16U,0x000A 表示：测量PM2.5值是 10ug/m3  范围0ug/m3到999ug/m3                                                                                                             |
|0x2C1D |通风湿度带宽             |   |INT16S,0x000A 表示：当前湿度带宽为10%    温度带宽范围1到10%                                                                                                             |
|0x2C1E |通风温度带宽             |   |INT16S,0x000A 表示：当前温度带宽为1.0度  温度带宽范围0.5到10                                                                                                             |
|0x2C1F |新风风机转速             |   |INT16U,0x00FA 表示：当前新风风机转速是255rpm                                                                                                             |
|0x2C20 |回风风机转速             |   |INT16U,0x00FA 表示：当前回风风机转速是255rpm                                                                                                             |
|0x2C21 |水机压缩机频率           |   |INT16U,0x000A 表示：当前频率为10hz                                                                                                             |
|0x2C22 |氟机压缩机频率           |   |INT16U,0x000A 表示：当前频率为10hz                                                                                                             |
|0x2C23 |主机供水温度             |   |INT16S,0x00FA 表示：当前温度是25.0度                                                                                                             |
|0x2C24 |主机生活热水温度         |   |INT16S,0x00FA 表示：当前温度是25.0度                                                                                                             |
|0x2C25 |主机进风测量温度(户外)T12|   |INT16S,0x00FA 表示：当前测量进风测量温度(户外)是25度                                                                                                             |
|0x2C26 |回风湿度值修正系数       |   |INT16S,0x0020 表示：湿度为32%    范围-100到100                                                                                                             |
|0x2C27 |回风温度值修正系数       |   |INT16S,0x000A 表示：温度为1℃    范围-100到100                                                                                                             |
|0x2C28 |回风CO2值修正系数        |   |INT16S,0x0020 表示：CO2为32      范围-2000到2000                                                                                                             |
|0x2C29 |回风PM2.5值修正系数      |   |INT16S,0x0020 表示：PM2.5为32    范围-999到999                                                                                                             |
|0x2C2A |户外进风口湿度值修正系数 |   |INT16S,0x0020 表示：湿度为32%    范围-100到100                                                                                                             |
|0x2C2B |户外进风口温度值修正系数 |   |INT16S,0x000A 表示：温度为1℃    范围-100到100                                                                                                             |
|0x2C2C |户外进风口CO2值修正系数  |   |INT16S,0x0020 表示：CO2为32      范围-2000到2000                                                                                                             |
|0x2C2D |户外进风口PM2.5值修正系数|   |INT16S,0x0020 表示：PM2.5为32    范围-999到999                                                                                                             |
|0x2C2E |氟盘前湿度值修正系数     |   |INT16S,0x0020 表示：湿度为32%    范围-100到100                                                                                                             |
|0x2C2F |氟盘前温度值修正系数     |   |INT16S,0x000A 表示：温度为1℃    范围-100到100                                                                                                             |
|0x2C30 |氟盘前CO2值修正系数      |   |INT16S,0x0020 表示：CO2为32      范围-2000到2000                                                                                                             |
|0x2C31 |氟盘前PM2.5值修正系数    |   |INT16S,0x0020 表示：PM2.5为32    范围-999到999                                                                                                             |
|0x2C32 |氟盘后湿度值修正系数     |   |INT16S,0x0020 表示：湿度为32%    范围-100到100                                                                                                             |
|0x2C33 |氟盘后温度值修正系数     |   |INT16S,0x000A 表示：温度为1℃    范围-100到100                                                                                                             |
|0x2C34 |氟盘后CO2值修正系数      |   |INT16S,0x0020 表示：CO2为32      范围-2000到2000                                                                                                             |
|0x2C35 |氟盘后PM2.5值修正系数    |   |INT16S,0x0020 表示：PM2.5为32    范围-999到999                                                                                                             |
|0x2C36 |回风口湿度值修正系数     |   |INT16S,0x0020 表示：湿度为32%    范围-100到100                                                                                                             |
|0x2C37 |回风口温度值修正系数     |   |INT16S,0x000A 表示：温度为1℃    范围-100到100                                                                                                             |
|0x2C38 |回风口CO2值修正系数      |   |INT16S,0x0020 表示：CO2为32      范围-2000到2000                                                                                                             |
|0x2C39 |回风口PM2.5值修正系数    |   |INT16S,0x0020 表示：PM2.5为32    范围-999到999                                                                                                             |
|0x2C3A |排风口湿度值修正系数     |   |INT16S,0x0020 表示：湿度为32%    范围-100到100                                                                                                             |
|0x2C3B |排风口温度值修正系数     |   |INT16S,0x000A 表示：温度为1℃    范围-100到100                                                                                                             |
|0x2C3C |排风口CO2值修正系数      |   |INT16S,0x0020 表示：CO2为32      范围-2000到2000                                                                                                             |
|0x2C3D |排风口PM2.5值修正系数    |   |INT16S,0x0020 表示：PM2.5为32    范围-999到999                                                                                                             |
|0x2C3E |混水制冷设定温度         |   |INT16U,0x0014 分辨率0.5   (步长)0.5度 当前设定温度是20.0度，                                                                                                             |
|0x2C3F |混水制热设定温度         |   |INT16U,0x0019 分辨率0.5   (步长)0.5度 当前设定温度是25.0度，                                                                                                               |
|0x2C40 |输配进水温度T11          |   |INT16U,0x00FF 分辨率0.1(取1位小数点) 当前温度是25.5度                                                                                                               |
|0x2C41 |输配回水温度T10          |   |INT16U,0x00FF 分辨率0.1(取1位小数点) 当前温度是25.5度                                                                                                                |
|0x2C42 |混水温度T9               |   |INT16U,0x00FF 分辨率0.1(取1位小数点) 当前温度是25.5度                                                                                                               |
|0x2C43 |输配水泵状态             |   |0:关闭 1:开启                                                                                                             |
|0x2C44 |输配三通阀门输出状态     |   |0:关闭 1:开启                                                                                                             |
|0x2C45 |输配混水AI目标温度       |   |INT16U,0x00FF 分辨率0.1(取1位小数点) 当前目标温度是25.5度                                                                                                             |
|0x2C46 |输配混水AI使能           |   |0:使能关 1:使能开                                                                                                             |
|0x2C47 |输配防冻保护             |   |0:关闭 1:开启                                                                                                             |
|0x2C48 |传感器错误               |   |详细列表待定                                                                                                             |
|0x2C49 |输配未绑定的阀门列表(风盘)内部接口|   |                                                                                                             |
|0x2C4A |输配未绑定的阀门列表(辐射)内部接口|   |                                                                                                             |
|0x2C4B |输配末端能量需求(主机联动)内部接口|   |                                                                                                             |
...
|Address|Name                     |R/W|Description                                                                                                  |
|-------|-------------------------|---|-------------------------------------------------------------------------------------------------------------|
|0x3000 |设备故障字               |   |bit0:传感器故障 bit1阀门绑定故障 bit2:EC风机故障                                                                                                |   
|0x3001 |在线状态                 |   |                                                                                                |   
|0x3002 |设备类型                 |   |                                                                                                |   
|0x3003 |设备ID0                  |   |                                                                                                |   
|0x3004 |设备ID1                  |   |                                                                                                |   
|0x3005 |设备ID2                  |   |                                                                                                |   
|0x3006 |开关机                   |   |写入1有效;Bit0:开机0x0001;Bit1:关机0x0002;                                                                                                |   
|0x3007 |制冷设定温度             |   |INT16U,0x0014 分辨率0.5   (步长)0.5度 当前设定温度是20.0度                                                                                                |   
|0x3008 |制热设定温度             |   |INT16U,0x0019 分辨率0.5   (步长)0.5度 当前设定温度是25.0度                                                                                                |   
|0x3008 |露点温度                 |   |INT16U,0x00FF 分辨率0.1(取1位小数点) 当前温度是25.5度                                                                                                |   
|0x300A |冷热运行状态             |   |0x0001:制冷 0x0002制热                                                                                                |   
|0x300B |防冻保护                 |   |0:关闭 1:开启（关闭时，默认防冻设定温度5度）                                                                                                |   
|0x300C |防冻设定温度             |   |INT16S,0x0032 分辨率0.5   (步长)0.5度 当前温度是5.0度， 范围 5 ~ 10度                                                                                                |   
|0x300D |童锁功能                 |   |0:关闭 1:开启                                                                                                |   
|0x300E |上电(关机)/(记忆)        |   |0:关闭 1:开启                                                                                                |   
|0x300F |制冷舒适设定温度         |   |INT16U,0x0014 分辨率0.5   (步长)0.5度 当前设定温度是20.0度                                                                                                |   
|0x3010 |制热舒适设定温度         |   |INT16U,0x0019 分辨率0.5   (步长)0.5度 当前设定温度是25.0度                                                                                                |   
|0x3011 |最高设定温度             |   |INT16U,0x0023 分辨率1(取0位小数点) (步长)0.5度 当前设定温度是35度， 范围:25.0度~35.0度                                                                                                |   
|0x3012 |最低设定温度             |   |INT16U,0x0005 分辨率1(取1位小数点) (步长)0.5度 当前设定温度是5度，  范围:5.0度~15.0度                                                                                                |   
|0x3013 |控温带宽                 |   |INT16S,0x000A 表示：当前带宽为1.0度   带宽范围0.5到10  默认 1                                                                                                |   
|0x3014 |露点带宽                 |   |INT16S,0x000A 表示：当前带宽为1.0度   带宽范围2度到10  默认 3                                                                                                |   
|0x3015 |测量温度                 |   |INT16U,0x00FF 分辨率0.1(取1位小数点) 当前温度是25.5度                                                                                                |   
|0x3016 |测量湿度                 |   |INT16U,0x002D 分辨率1 当前湿度是45%                                                                                                |   
|0x3017 |辐射阀门需求             |   |0:无需求 1:有需求                                                                                                |   
|0x3018 |设定风速                 |   |0x0000:AI风速 0x0001:低风  0x0002:中风   0x0003:高风                                                                                                |   
|0x3019 |风机受控                 |   |0:不受控 1:受控                                                                                                |   
|0x301A |低风量PWM值              |   |INT16U,0x0020 表示：PWM输出值为32%    范围0%到100%                                                                                                 |   
|0x301B |中风量PWM值              |   |INT16U,0x0020 表示：PWM输出值为32%    范围0%到100%                                                                                                 |   
|0x301C |高风量PWM值              |   |INT16U,0x0020 表示：PWM输出值为32%    范围0%到100%                                                                                                 |   
|0x301D |AI制冷协同带宽           |   |INT16S,0x000A 表示：当前带宽为10   带宽范围2到10 默认3                                                                                                |   
|0x301E |AI制热协同带宽           |   |INT16S,0x000A 表示：当前带宽为10   带宽范围2到10 默认3                                                                                                |   
|0x301F |制冷协同使能             |   |0:关闭 1:开启（关闭时，单独控制；开启时，同时控制）                                                                                                |   
|0x3020 |制热协同使能             |   |0:关闭 1:开启（关闭时，单独控制；开启时，同时控制）                                                                                                |   
|0x3021 |风阀需求                 |   |0:关闭 1:开启                                                                                                |   
|0x3022 |风机输出状态             |   |0x0000:无风 0x0001:低风  0x0002:中风   0x0003:高风                                                                                                |   
|0x3023 |EC风机转速               |   |INT16U,0x00FA 表示：当前新风风机转速是255rpm                                                                                                |   
|0x3024 |末端状态                 |   |0:单末端 1:双末端                                                                                                |   
|0x3025 |双末端模式选择           |   |0:辐射 1:风盘 2:智能                                                                                                |   
...
|-------|-------------------------|---|-------------------------------------------------------------------------------------------------------------|
|0x3A00 |2#室内软件版本           |   |                                                                                                |   
|0x3A01 |2#室内机型               |   |0-全联供室内机 1-风管机室内机 2-恒温除湿室内机 3-变频除湿机                                                                                           |   
|0x3A02 |2#室内能力               |   |0-1.0HP 1-1.5HP 2-2.0HP 3-3.0HP                                                                                               |   
|0x3A03 |2#实际过热度             |   |100-10.0℃                                                                                                |   
|0x3A04 |2#压缩机实际频率         |   |100-100Hz                                                                                                |   
|0x3A05 |2#压缩机限频状态         |   |                                                                                                |   
|0x3A06 |2#压缩机电流             |   |100-10.0A                                                                                                |   
|0x3A07 |2#输入电流               |   |100-10.0A                                                                                                |   
|0x3A08 |2#相电压                 |   |100-10.0V                                                                                                |   
|0x3A09 |2#母线电压               |   |100-10.0V                                                                                                |   
|0x3A0A |2#模块温度               |   |100-10.0V                                                                                                |   
|0x3A0B |2#室外EXV3开度           |   |100-100步                                                                                                |   
|0x3A0C |2#室内EXV1开度           |   |100-100步                                                                                                |   
|0x3A0D |2#室外风机实际转速       |   |100-100RPM                                                                                                |   
|0x3A0E |2#TH10排温温度           |   |100-10.0℃                                                                                                    |   
|0x3A0F |2#TH11吸气温度           |   |100-10.0℃                                                                                                    |   
|0x3A10 |2#TH12中盘温度           |   |100-10.0℃                                                                                                    |   
|0x3A11 |2#TH13出盘温度           |   |100-10.0℃                                                                                                    |   
|0x3A12 |2#TH14热水水箱温度       |   |100-10.0℃                                                                                                    |   
|0x3A13 |2#室外SV2电磁阀状态      |   |0-闭合;  1-断开;                                                                                                |   
|0x3A14 |2#室外SV2电磁阀状态      |   |0-闭合;  1-断开;                                                                                                |   
|0x3A15 |2#室外SV1电磁阀状态      |   |0-闭合;  1-断开;                                                                                                |   
|0x3A16 |2#室外四通阀1状态        |   |0-闭合;  1-断开;                                                                                                |   
|0x3A17 |2#室外四通阀2状态        |   |0-闭合;  1-断开;                                                                                               |   
|0x3A18 |2#室内TH1再热中盘温度    |   |100-10.0℃                                                                                                  |   
|0x3A19 |2#室内TH2除湿中盘温度    |   |100-10.0℃                                                                                                  |   
|0x3A1A |2#能力需求               |   |100-100                                                                                                |   
|0x3A1B |2#压缩机目标频率         |   |100-100Hz                                                                                                |   
|0x3A1C |2#风机目标转速           |   |100-100RPM                                                                                                |   
|0x3A1D |2#室内TH3回风温度        |   |100-10.0℃                                                                                                |   
|0x3A1E |1#室外软件版本           |   |                                                                                                |   
|0x3A1F |1#从机数量：             |   |1-1台                                                                                                       |   
|0x3A20 |1#室外低温普通           |   |0-普通；    1-低温；                                                                                                |   
|0x3A21 |1#室外机型：             |   |0-MC005 1-预留 2-预留 3-预留                                                                                               |   
|0x3A22 |1#实际过热度             |   |100-10.0℃                                                                                                |   
|0x3A23 |1#压缩机实际频率         |   |100-100Hz                                                                                                |   
|0x3A24 |1#压缩机限频状态         |   |                                                                                                |   
|0x3A25 |1#压缩机电流             |   |100-10.0A                                                                                                |   
|0x3A26 |1#输入电流               |   |100-10.0A                                                                                                |   
|0x3A27 |1#相电压                 |   |100-10.0V                                                                                                |   
|0x3A28 |1#母线电压               |   |100-10.0V                                                                                                |   
|0x3A29 |1#模块温度               |   |100-10.0℃                                                                                                |   
|0x3A2A |1#室外EXV1开度           |   |100-100步                                                                                                |   
|0x3A2B |1#室外EXV2开度           |   |100-100步                                                                                                |   
|0x3A2C |1#循环水泵状态           |   |0-停止;   1-运行;                                                                                                |   
|0x3A2D |1#风机实际转速           |   |100-100RPM                                                                                                |   
|0x3A2E |1#TH1排温温度            |   |100-10.0℃                                                                                                |   
|0x3A2F |1#TH2吸气温度            |   |100-10.0℃                                                                                                |   
|0x3A30 |1#TH3中盘温度            |   |100-10.0℃                                                                                                |   
|0x3A31 |1#TH9出盘温度            |   |100-10.0℃                                                                                                |   
|0x3A32 |1#TH4经济器进口温度      |   |100-10.0℃                                                                                                |   
|0x3A33 |1#TH5经济器出口温度      |   |100-10.0℃                                                                                                |   
|0x3A34 |1#TH6进水温度            |   |100-10.0℃                                                                                                |   
|0x3A35 |1#TH7出水温度            |   |100-10.0℃                                                                                                |   
|0x3A36 |1#TH8环境温度            |   |100-10.0℃                                                                                                |   
|0x3A37 |1#能力需求               |   |100-100                                                                                                |   
|0x3A38 |故障1   详细故障见附表   |   |BIT0 0#从机通讯故障                                                                                                  |   
|       |                         |   |BIT1 1#从机通讯故障                                                                                                |   
|       |                         |   |BIT2 2#从机通讯故障                                                                                                |   
|       |                         |   |BIT3 3#从机通讯故障                                                                                                |   
|       |                         |   |BIT4 4#从机通讯故障                                                                                                |   
...
|       |                         |   |BIT7 7#从机通讯故障                                                                                                |   
|       |                         |   |BIT8~BIT15 预留                                                                                                |   
|0x3A39 |故障2   详细故障见附表   |   |BIT0 1#排气温度传感器故障                                                                                                |   
|       |                         |   |BIT1 1#吸气温度传感器故障                                                                                                |   
|       |                         |   |BIT2 1#中盘温度传感器故障                                                                                                |   
|       |                         |   |BIT3 1#辅路进口温度传感器故障                                                                                                |   
|       |                         |   |BIT4 1#辅路出口温度传感器故障                                                                                                |   
...
|       |                         |   |BIT14 1#低压传感器故障                                                                                                |   
|       |                         |   |BIT15 保留                                                                                                |   
|0x3A3A |故障3   详细故障见附表   |   |BIT0~BIT1 保留                                                                                                |   
|       |                         |   |BIT2 1#电流互感器1故障                                                                                                |   
|       |                         |   |BIT3 1#电流互感器2故障                                                                                                |   
|       |                         |   |BIT4 1#电流互感器3故障                                                                                                |   
|       |                         |   |BIT5 1#电流互感器4故障                                                                                                |   
...
|       |                         |   |BIT14 1#吸气过热度小                                                                                                |   
|       |                         |   |BIT15 1#排气过热度小                                                                                                |   
|0x3A3B |故障4   详细故障见附表   |   |BIT0 1#排气温度过高                                                                                                |   
|       |                         |   |BIT1 1#环境温度过高过低                                                                                                |   
|       |                         |   |BIT2 1#冷媒不足                                                                                                 |   
|       |                         |   |BIT3 1#吸气温度过高                                                                                                |   
|       |                         |   |BIT4 1#出水温度过高                                                                                                |   
...
|       |                         |   |BIT14 1#直流母线欠压                                                                                                |   
|       |                         |   |BIT15 1#输出缺相                                                                                                |   
|0x3A3C |故障5   详细故障见附表   |   |BIT0 1#电机低速过流                                                                                                |   
|       |                         |   |BIT1 1#同向飞车保护                                                                                                |   
|       |                         |   |BIT2 1#逆变输出瞬时过流                                                                                                |   
|       |                         |   |BIT3 1#输入电压过高                                                                                                |   
|       |                         |   |BIT4 1#输入电压过低                                                                                                |   
...
|       |                         |   |BIT14 1#通讯故障                                                                                                |   
|       |                         |   |BIT15 1#输入电源不正常                                                                                                |   
|0x3A3D |故障6   详细故障见附表   |   |BIT0 1#新I2t瞬时过流                                                                                                |   
|       |                         |   |BIT1 1#新电流有效值过流                                                                                                |   
|       |                         |   |BIT2 1#运行输出电流异常                                                                                                |   
|       |                         |   |BIT3 1#其他故障                                                                                                |   
|       |                         |   |BIT4~BIT7 保留                                                                                               |   
...
|       |                         |   |BIT14 1#欠压保护                                                                                                |   
|       |                         |   |BIT15 1#缺相保护                                                                                                |   
|0x3A3E |故障7   详细故障见附表   |   |BIT0 1#直流风机故障1                                                                                                |   
|       |                         |   |BIT1 1#直流风机故障2                                                                                                |   
|       |                         |   |BIT2~BIT7 保留                                                                                                |   
|       |                         |   |BIT8 1#U相电流检测故障                                                                                                |   
|       |                         |   |BIT9 1#V相电流检测故障                                                                                                |   
...
|       |                         |   |BIT14 1#通讯板与模块通讯故障                                                                                                |   
|       |                         |   |BIT15 1#输入电压检测故障                                                                                                |   
|0x3A3F |故障8   详细故障见附表   |   |BIT0 1#散热器温度检测故障                                                                                                |   
|       |                         |   |BIT1 1#IPM模块温度检测故障                                                                                                |   
|       |                         |   |BIT2 1#输出过流保护                                                                                                |   
|       |                         |   |BIT3 1#EEPROM故障                                                                                                |   
|       |                         |   |BIT4 1#压缩机ID号错故障                                                                                                 |   
|       |                         |   |BIT5~BIT15 保留                                                                                                |   
|0x3A40 |故障9   详细故障见附表   |   |BIT0 2#与驱动2通讯故障                                                                                                |   
...
|       |                         |   |BIT14 2#排温温度传感器故障                                                                                                |   
|       |                         |   |BIT15 2#中盘温度传感器故障                                                                                                |   
|0x3A41 |故障10   详细故障见附表  |   |BIT0 2#出盘温度传感器故障                                                                                                |   
|       |                         |   |BIT1 2#热水水箱温度传感器故障                                                                                                |   
|       |                         |   |BIT2 2#低压故障                                                                                                |   
|       |                         |   |BIT3 2#高压故障                                                                                                |   
|       |                         |   |BIT4 2#吸气温度过高                                                                                                |   
...
|       |                         |   |BIT8 2#环境温度过高过低                                                                                                |   
|       |                         |   |BIT9~BIT15 保留                                                                                                |   
|0x3A42 |故障11   详细故障见附表  |   |BIT0 2#冷驱动器IPM模块硬件过流                                                                                                | 
|       |                         |   |BIT1 2#冷驱动器IPM模块过热                                                                                                |   
|       |                         |   |BIT2 2#冷驱动器PFC模块过热                                                                                                |   
|       |                         |   |BIT3 2#冷驱动器PFC瞬间过流                                                                                                |   
|       |                         |   |BIT4 2#冷压缩机失步保护                                                                                                |   
...
|0x3A43 |故障12   详细故障见附表  |   |BIT0 2#冷驱动器PFC模块硬件过流（IGBT短路保护）                                                                                                |   
|       |                         |   |BIT1 2#冷其他故障                                                                                                |   
|       |                         |   |BIT2 2#冷驱动器芯片复位故障                                                                                                |   
|       |                         |   |BIT3 2#冷驱动器存储芯片故障                                                                                                |   
...
|       |                         |   |7-制冷测试模式                                                                                                |   
|       |                         |   |8-制热测试模式                                                                                                 |   
|0x3B02 |开关机                   |   |0-开机;    1-关机;                                                                                                |   
|0x3B03 |2#热水模式使能           |   |0-关闭;    1-启用;                                                                                                |   
|0x3B04 |2#热水消毒功能           |   |0-禁用;    1-启用;                                                                                                |   
|0x3B05 |2#制冷模式优先           |   |0-除湿优先;1-制冷优先;                                                                                                |   
|0x3B06 |2#制热模式优先           |   |0-制热优先;1-热水优先;                                                                                                |   
|0x3B07 |2#制冷回风设置温度       |   |100-10.0℃                                                                                                |   
|0x3B08 |2#制热回风设置温度       |   |100-10.0℃                                                                                                |   
|0x3B09 |2#相对湿度设置温度       |   |100-10.0%                                                                                                |   
|0x3B0A |2#生活热水设置温度       |   |100-10.0℃                                                                                                |   
|0x3B0B |2#热水侧压缩机能力修正系数|   |95-0.95                                                                                                |   
|0x3B0C |2#除湿侧压缩机能力修正系数|   |95-0.95                                                                                                |   
|0x3B0D |2#目标过热度             |   |100-10.0℃                                                                                                |   
|0x3B0E |2#除霜检测线A点          |   |100-10.0℃                                                                                                |   
|0x3B0F |2#除霜检测线B点          |   |100-10.0℃                                                                                                |   
|0x3B10 |2#除霜出盘结束温度       |   |100-10.0℃                                                                                                |   
|0x3B11 |2#除霜间隔时间           |   |100-100min                                                                                                |   
|0x3B12 |2#除霜最大运行时间       |   |100-100min                                                                                                |   
|0x3B13 |2#压缩机频率计算周期     |   |100-100s                                                                                                |   
|0x3B14 |2#压缩机最高运行频率     |   |100-100Hz                                                                                                |   
|0x3B15 |2#风机最高转速           |   |100-100转                                                                                                  |   
|0x3B16 |2#吸气过热度修正值       |   |100-10.0℃                                                                                                |   
|0x3B17 |2#功能特征               |   |0-无排水泵、水位开关、辅助电加热;                                                                                                |   
|       |                         |   |1-排水泵及水位开关;                                                                                                |   
|       |                         |   |2-辅助电加热;                                                                                            |   
|       |                         |   |3-排水泵、水位开关、辅助电加热;                                                                            |   
|0x3B18 |1#制冷出水设置温度       |   |100-10.0℃                                                                                                 |   
|0x3B19 |1#制冷回水设置温度       |   |100-10.0℃                                                                                                 |   
|0x3B1A |1#制热出水设置温度       |   |100-10.0℃                                                                                                 |   
|0x3B1B |1#制热回水设置温度       |   |100-10.0℃                                                                                                 |   
|0x3B1C |1#冬季防冻设置温度       |   |100-10.0℃                                                                                                 |   
|0x3B1D |1#制冷防冻设置温度       |   |100-10.0℃                                                                                                 |   
|0x3B1E |1#目标过热度             |   |100-10.0℃                                                                                                 |   
|0x3B1F |1#除霜检测线A点          |   |100-10.0℃                                                                                                 |   
|0x3B20 |1#除霜检测线B点          |   |100-10.0℃                                                                                                 |   
|0x3B21 |1#除霜出盘结束温度       |   |100-10.0℃                                                                                                 |   
|0x3B22 |1#除霜间隔时间           |   |100-100min                                                                                                 |   
|0x3B23 |1#除霜最大运行时间       |   |100-100min                                                                                                 |   
|0x3B24 |1#压缩机频率计算周期     |   |100-100s                                                                                                |   
|0x3B25 |1#压缩机最高运行频率     |   |100-100Hz                                                                                                |   
|0x3B26 |1#压缩机设置频率         |   |100-100Hz                                                                                                |   
|0x3B27 |1#风机最高转速           |   |100-100RMP                                                                                                  |   
|0x3B28 |室内风机控制使能         |   |0-禁用;   1-启用;                                                                                                |   
|0x3B29 |室内风机转速             |   |额定转速直接发1; 高速发1.05; 低速发0.95;                                                                                               |   
|0x3B2A |室内电动二通阀状态       |   |0-停止；   1-运转；                                                                                                |   
|0x3B2B |室内排水泵状态           |   |0-停止；   1-运转；                                                                                                |   
|0x3B2C |室内水位开关状态         |   |0-闭合；   1-断开；                                                                                                |   
|0x3B2D |室内电加热状态           |   |0-停止；   1-运转；                                                                                                |   
|0x3B2E |室内EXV1开度             |   |100-100步                                                                                                |   
|0x3B2F |室内回风湿度值           |   |100-10.0%                                                                                                |   
|0x3B30 |室内进风湿度值           |   |100-10.0%                                                                                                |   
|0x3B31 |室内进风温度值           |   |100-10.0℃                                                                                                |   
|0x3B32 |室内回风温度值           |   |100-10.0℃                                                                                                |   
|0x3B33 |室内机故障               |   |BIT0 室内机与上位机通讯故障                                                                                                 |   
|       |                         |   |BIT1 室内风机故障                                                                                                |   
|       |                         |   |BIT2 室内排水泵故障                                                                                                |   
|       |                         |   |BIT3 室内水位开关故障                                                                                                |   
|       |                         |   |BIT4 室内二通阀故障                                                                                                |   
